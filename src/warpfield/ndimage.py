...
def zoom(arr, zoom_factors, order=1, mode="constant"):
    ...
    Args:
        ...
        zoom_factors (tuple of float): Zoom factors for each axis. Values greater than 1 result in a larger output array,
            while values less than 1 result in a smaller array. Divide the the physical voxel size of the input array by these values to get the physical voxel size of the output array.
