...
<sup>Example: region-level registration across different subjects (video slowed down ~5x). warpfield can also perform cell-level within-subject registrations of microscopy data.</sup>
